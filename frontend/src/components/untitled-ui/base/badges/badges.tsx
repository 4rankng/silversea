...
export const filledColors: Record<BadgeColors, { root: string; addon: string; addonButton: string }> = {
    gray: {
        root: "bg-transparent ring-transparent text-utility-neutral-700",
    ...
    purple: {
        root: "bg-transparent ring-transparent text-utility-purple-700",
    ...
    pink: {
        root: "bg-transparent ring-transparent text-utility-pink-700",
        addon: "text-utility-pink-500",
        addonButton: "hover:bg-utility-pink-100 text-utility-pink-400 hover:text-utility-pink-500",
    },
    orange: {
        root: "bg-transparent ring-transparent text-utility-orange-700",
