...
/**
 * 24h time-first datetime input for the trip-pairing form (combined date+time
 * contract, 2026-09-09): a native datetime-local renders 12h AM/PM per
 * browser locale and cannot be forced, so this buffers a text input in the
 * fixed `HH:mm DD/MM/YYYY` shape. Value contract unchanged
 * ('YYYY-MM-DDTHH:mm' in and out).
 */
