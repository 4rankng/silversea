...
const pageStyles = `
  ...
  .pr-act {
    ...
    /* Native-button reset: the actions were divs with onClick (invisible to
       keyboard users); as buttons they must not inherit UA chrome. */
    appearance: none;
    padding: 0;
    font: inherit;
    line-height: 0;
                  ...
                  <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
                    ...
                    <div className="pr-card-actions">
                      <button
                        type="button"
                        className="pr-act"
                        aria-label={`Chỉnh sửa ${d.reasonText}`}
                        title="Chỉnh sửa"
                        onClick={() => crud.setEditingId(d.id)}
                      >
