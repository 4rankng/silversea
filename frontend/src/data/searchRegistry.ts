...
export const CONFIG_ITEMS: SearchItem[] = [
  ...
  { id: 'factories',              type: 'config', label: 'Nhà máy / Kho',                  description: 'Danh mục nhà máy và kho lấy hàng của từng khách hàng — tuyến chuẩn, liên hệ, xuất hóa đơn nâng hạ.', path: '/config/factories',           iconName: 'company-profile', action: 'Sửa' },
  ...
  { id: 'app-settings',          type: 'config', label: 'Cài đặt ứng dụng',               description: 'Bật/tắt tính năng và chọn nhà cung cấp AI.',                       path: '/config/app-settings',          iconName: 'app-settings', action: 'Sửa', adminOnly: true },
];
