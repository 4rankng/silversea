...
>
> **Status:** These are **proposals, not approved requirements.** The source document
> states on its cover: _"Các ngưỡng tiền, tỷ lệ và lịch gửi phải cấu hình được và cần
> Silver Sea xác nhận trước khi triển khai."_ All items below are the defaults TingTing
> recommends; they become formal requirements only after Silver Sea signs off in writing.
> Treat this file as the single place to track which default is accepted, rejected, or
> modified per question.
