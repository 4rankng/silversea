...
def test_auth(ctx: NepoTestContext, results: TestResults):
    ...
    page.fill('input[id="identifier"], input[placeholder*="Tên đăng nhập"]', 'giamdoc')
    ...
    if '/dashboard' in page.url:
        ...
        results.fail_('TC-0001', 'Login by username', f'Expected /dashboard, got {page.url}')
    ...
    page.goto(f'{BASE_URL}/login')
    page.wait_for_load_state('networkidle')
    page.fill('input[id="identifier"], input[placeholder*="Tên đăng nhập"]', 'laixe')
    page.fill('input[type="password"]', 'admin123')
    page.click('button[type="submit"], button:has-text("Đăng nhập")')
    page.wait_for_load_state('networkidle')
    page.wait_for_timeout(1000)
    if '/my-trips' in page.url:
        ...
        results.fail_('TC-0004', 'Login DRIVER', f'Expected /my-trips, got {page.url}')
    page.close()
    ...
    page.goto(f'{BASE_URL}/login')
    page.wait_for_load_state('networkidle')
    page.fill('input[id="identifier"], input[placeholder*="Tên đăng nhập"]', 'giaonhan')
    page.fill('input[type="password"]', 'admin123')
    page.click('button[type="submit"], button:has-text("Đăng nhập")')
    page.wait_for_load_state('networkidle')
    page.wait_for_timeout(1000)
    if '/my-forwarder-trips' in page.url:
        ...
        results.fail_('TC-0004b', 'Login FORWARDER', f'Expected /my-forwarder-trips, got {page.url}')
    page.close()
    ...
    if logout_btn.is_visible():
        ...
        if '/login' in page.url or page.locator('input[type="password"]').count() > 0:
            ...
            results.fail_('TC-0006', 'Logout', f'Expected login page, got {page.url}')
    else:
    ...
    if resp.get('error') and resp.get('status') == 401:
        ...
        results.fail_('TC-0011', 'Wrong password', f'Expected auth error, got {resp}')
    ...
    if '/login' in page.url or page.url == f'{BASE_URL}/':
        results.pass_('TC-0009', 'Empty identifier → validation error')
    else:
        results.fail_('TC-0009', 'Empty identifier', f'Expected validation, got {page.url}')
    page.close()
    ...
    if '/my-trips' in page.url:
        ...
        results.fail_('TC-0014', 'DRIVER redirect', f'Expected /my-trips, got {page.url}')
    page.close()
    ...
    if '/my-trips' in page.url:
        ...
        results.fail_('TC-0015', 'DRIVER → /finance redirect', f'Got {page.url}')
    page.close()
    ...
    if resp.get('status') == 403:
        ...
        results.fail_('TC-0018', 'DRIVER API access', f'Expected 403, got {resp.get("status")}')
    ...
    if '/dashboard' in page.url:
        ...
        results.fail_('TC-0020', 'ADMIN driver redirect', f'Expected /dashboard, got {page.url}')
    page.close()
    ...
    if '/dashboard' in page.url:
        ...
        results.fail_('TC-0022', '404 catch-all', f'Expected /dashboard, got {page.url}')
    page.close()
    ...
    if '/my-forwarder-trips' in page.url:
        ...
        results.fail_('TC-0034', 'FORWARDER portal', f'Expected /my-forwarder-trips, got {page.url}')
    page.close()
    ...
    if '/my-forwarder-trips' in page.url:
        ...
        results.fail_('TC-0035', 'FORWARDER dashboard redirect', f'Got {page.url}')
    page.close()
    ...
    if '/my-forwarder-trips' in page.url:
        ...
        results.fail_('TC-0036', 'FORWARDER finance redirect', f'Got {page.url}')
    page.close()
    ...
    if '/my-forwarder-trips' in page.url:
        ...
        results.fail_('TC-0037', 'FORWARDER driver redirect', f'Got {page.url}')
    page.close()
    ...
    if '/dashboard' in page.url:
        ...
        results.fail_('TC-0038', 'ADMIN forwarder redirect', f'Got {page.url}')
    page.close()
    ...
    if '/my-trips' in page.url:
        ...
        results.fail_('TC-0039', 'DRIVER forwarder redirect', f'Got {page.url}')
    page.close()
    ...
    if resp.get('status') == 403:
        ...
        results.fail_('TC-0040', 'FORWARDER API access', f'Expected 403, got {resp.get("status")}')
    ...
    if '/my-forwarder-trips' in page.url:
        ...
        results.fail_('TC-0042', '404 catch-all FORWARDER', f'Got {page.url}')
    page.close()
    ...
    if len(visible_items) >= 1 and any('Chuyến đi' in t for t in visible_items):
        ...
        results.fail_('TC-0041', 'FORWARDER sidebar', f'Found items: {visible_items}')
