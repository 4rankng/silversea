...
def test_config(ctx: NepoTestContext, results: TestResults):
    ...
    if '/config' in page.url:
        ...
        results.fail_('TC-0901', 'Config page', f'URL: {page.url}')
    ...
    if '/config/routes' in page.url:
        ...
        results.fail_('TC-0902', 'Routes config', f'URL: {page.url}')
    page.close()
    ...
    if '/config/fuel' in page.url:
        ...
        results.fail_('TC-0903', 'Fuel config', f'URL: {page.url}')
    page.close()
    ...
    if resp.get('status') == 200:
        ...
        results.fail_('TC-0904', 'Catalogs bootstrap', f'Status: {resp.get("status")}')
    ...
    if resp.get('status') == 200:
        ...
        results.fail_('TC-0905', 'Routes API', f'Status: {resp.get("status")}')
    ...
    if resp.get('status') == 200:
        ...
        results.fail_('TC-0906', 'Cargo types API', f'Status: {resp.get("status")}')
    ...
    if resp.get('status') == 200:
        ...
        results.fail_('TC-0907', 'Pricing tables', f'Status: {resp.get("status")}')
    ...
    if resp.get('status') == 200:
        ...
        results.fail_('TC-0908', 'Road allowances', f'Status: {resp.get("status")}')
    ...
    if resp.get('status') == 200:
        ...
        results.fail_('TC-0909', 'Fuel config API', f'Status: {resp.get("status")}')
    ...
    if resp.get('status') == 200:
        ...
        results.fail_('TC-0910', 'Penalty reasons', f'Status: {resp.get("status")}')
    ...
    if resp.get('status') == 200:
        ...
        results.fail_('TC-0911', 'Salary periods', f'Status: {resp.get("status")}')
    ...
    if resp.get('status') == 403:
        ...
        results.fail_('TC-0912', 'DRIVER config', f'Expected 403, got {resp.get("status")}')
