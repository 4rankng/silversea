...
export const TRIP_FINANCIAL_FIELD_NAMES: ReadonlySet<string> = new Set([
  ...
  'fuelSurchargeSnapshotDirty', 'totalRoadAllowance', 'tollCost', 'tollDeduction', 'reconciledTollCost', 'reconciledExtraCost',
...
function selectFinancialColumns() {
  ...
  return {
    ...
    reconciledTollCost: f.reconciledTollCost, reconciledExtraCost: f.reconciledExtraCost,
