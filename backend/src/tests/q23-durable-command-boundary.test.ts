...
describe('Q23 durable command boundary', () => {
  ...
  test('declares the integrated Q23 material-write routes in the centralized registry', () => {
    const samples = [
      ...
      ['POST', '/api/finance/credit-overrides/1/check', 'credit-overrides.check'],
      ['POST', '/api/finance/credit-overrides/1/approve', 'credit-overrides.approve'],
      ['POST', '/api/finance/credit-overrides/1/reject', 'credit-overrides.reject'],
