...
const MATERIAL_WRITE_RULES: readonly MaterialWriteRule[] = [
  ...
  { method: 'POST', endpoint: 'treasury.accounts.setup.request', pattern: /^\/api\/finance\/treasury\/accounts\/setup$/ },
  { method: 'POST', endpoint: 'treasury.accounts.cutover.request', pattern: /^\/api\/finance\/treasury\/accounts\/[^/]+\/cutover$/ },
  { method: 'POST', endpoint: 'treasury.movements.reversal.request', pattern: /^\/api\/finance\/treasury\/movements\/[^/]+\/reversal$/ },
  ...
  { method: 'POST', endpoint: 'admin.faq-entries.create', pattern: /^\/api\/admin\/faq-entries$/ },
  { method: 'PUT', endpoint: 'admin.faq-entries.update', pattern: /^\/api\/admin\/faq-entries\/[^/]+$/ },
  { method: 'DELETE', endpoint: 'admin.faq-entries.delete', pattern: /^\/api\/admin\/faq-entries\/[^/]+$/ },
  ...
  { method: 'PUT', endpoint: 'admin.onboarding-settings.update', pattern: /^\/api\/admin\/onboarding-settings$/ },
